...
class PurchaseBill(models.Model):
    ...
    eta = models.CharField(max_length=3, default=48)
    vehicle = models.CharField(max_length=15, default='ZC 12334')
    def __str__(self):
    ...
    @property
    def get_total(self):
        return (self.get_total_price() - (self.get_total_price()*(self.vat/100) + (self.get_total_price()*(self.discount/100) + self.delivery_fee)))
