...
class PurchaseCreateView(View):                                                 
    ...
    def post(self, request, pk):
        ...
        if formset.is_valid():
            ...
            return redirect('purchase-bill', pk=billobj.billno)
...
class SaleCreateView(View):                                                      
    ...
    def post(self, request):
        ...
        if form.is_valid() and formset.is_valid():
            ...
            return redirect('sale-bill', pk=billobj.billno)
        form = SaleForm(request.GET or None)
...
class PurchaseBillView(View):
    ...
    def get(self, request, pk):
        context = {
            'bill'          : PurchaseBill.objects.get(pk=pk),
            'items'         : PurchaseItem.objects.filter(billno=pk),
...
class SaleBillView(View):
    ...
    def get(self, request, pk):
        context = {
            'bill'          : SaleBill.objects.filter(pk=pk),
            'items'         : SaleItem.objects.filter(billno=pk),
            'bill_base'     : self.bill_base,
        }
        return render(request, self.template_name, context)
